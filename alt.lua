...
function Library.Init(options)
    ...
    if _G.Settings.Position == nil then
        ...
        save()
            ...
            TabContainer.Position = UDim2.new(0.122314051, 0, 0, 0)
            TabContainer.Size = UDim2.new(0, 531, 0, 35)
            ...
            function Tabs:Tab(tabname)
                ...
                function Elements:NewToggle(options)
                    ...
                    TextButton.MouseButton1Click:Connect(function()
                        State = not State
                        local NewColour = State and Color3.fromRGB(240, 101, 54) or Color3.fromRGB(35, 35, 35)
                        TweenService:Create(ToggleBack, TweenInfo.new(.25), {BackgroundColor3 = NewColour}):Play()
                        pcall(callback, State)
                    end)
                    if default then
                        ToggleBack.BackgroundColor3 = Color3.fromRGB(240, 101, 54)
                        pcall(callback, State)
                    else
...
local check = true 
            ...
            function Elements:NewSlider(options)
                ...
                SliderBack.BackgroundColor3 = Color3.fromRGB(240, 101, 54)
